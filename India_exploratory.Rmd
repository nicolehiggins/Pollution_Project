...
```{r}
india_city_pollution %>% 
  ggplot(aes(x = Date, y = NO2, color = City)) +
  geom_line() +
  facet_wrap(vars(City)) +
  labs(title = "Nitrogen Dioxide Concentration in Major Indian Cities from 2015-2020")
```

```{r}
india_city_pollution %>% 
  ggplot(aes(x = Date, y = SO2, color = City)) +
  geom_line() +
  facet_wrap(vars(City)) +
  labs(title = "Sulphur Dioxide Concentration in Major Indian Cities from 2015-2020")
```

```{r}
india_city_pollution %>% 
  ggplot(aes(x = Date, y = O3, color = City)) +
  geom_line() +
  facet_wrap(vars(City)) +
  labs(title = "Ozone Concentration in Major Indian Cities from 2015-2020")
```

```{r}
india_city_pollution %>% 
  ggplot(aes(x = Date, y = CO, color = City)) +
  geom_line() +
  facet_wrap(vars(City)) +
  labs(title = "Carbon Monoxide Concentration in Major Indian Cities from 2015-2020")
```
```{r}
...
```{r}
india_factory_pollution %>% 
  ggplot(aes(y = 'State', x = 'Number of Factories - 2014-15')) +
  geom_col()
